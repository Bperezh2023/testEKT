...
class PlacaPorEntregar extends StatefulWidget {
  const PlacaPorEntregar({Key? key}) : super(key: key);

  @override
  State<PlacaPorEntregar> createState() => _PlacaPorEntregarState();
}

class _PlacaPorEntregarState extends State<PlacaPorEntregar> {
        ...
        builder: (BuildContext context){
          return AlertDialog(
            ...
            content: SingleChildScrollView(
              child: ListBody(
                children: [
                  Text('Tu archivo será enviado a revisión, ¿Estás segur@ que deseas subirlo?',
                    style: TextStyle(color: Colors.blueGrey, fontSize: 20),
                  ),
                ],
              ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text("Ver Documentos", style: TextStyle(
                        fontWeight: FontWeight.w500)),
                  ],
                ),
                SizedBox(
