...
class RespuestaApiFile {
  ...
  RespuestaApiFile(this.id, this.name, this.attached_to_doctype,
  ...
  RespuestaApiFile.fromJson(Map<String, dynamic> json){
    id = json['id'];
    name = json['name'];
